...
class ConcreteHandler1(Handler): #Inherits from the abstract handler
    ...
    def _handle(self, request):
        if 0 < request <= 10: #Provide a condition for handling
            print("Request {} handled is handler 1".format(request))
...
class Client: #Using handlers
    def __init__(self):
        self.handler = ConcreteHandler1(DefaultHandler(None))#Create handlers and use them in a sequence ypu want
