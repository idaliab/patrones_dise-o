class House(object): #The class being visited
    ...
    def work_on_electricity(self, electrician):
        print(self, "worked on by", electrician) #Note that we now have a refrence to the electrician object in the house object!
...
class HvacSpecialist(Visitor): #Inherits from the parent class, Visitor
    ...
    def visit(self, house):
        house.work_on_hvac(self) #None that the visitor now has a reference to the house object
